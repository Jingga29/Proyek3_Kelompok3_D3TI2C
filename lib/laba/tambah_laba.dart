...
class TambahLaba extends StatefulWidget {
  const TambahLaba({Key? key}) : super(key: key);

  @override
  State<TambahLaba> createState() => _TambahLabaState();
}

class _TambahLabaState extends State<TambahLaba> {
  ...
  Future<bool> _simpan() async {
    final response = await http.post(
      Uri.parse('http://192.168.0.2/api_proyek3/laba/create.php'),
      body: {
